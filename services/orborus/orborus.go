...
// Initial loop etc
func runOrborus(baseUrl string, orgId string, environment string, dockerApiVersion string) {
	zombiecheck()
	...
	for {
		...
		var executionRequests model.ExecutionRequestWrapper
		...
		var toBeRemoved model.ExecutionRequestWrapper
